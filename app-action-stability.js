...
function isStableAction(el){
  ...
  if(b.matches('[data-cc-party-push],[data-cc-party-clear],[data-vamf-party],[data-ccq-party-other],[data-sw-party],[data-gcs-add-player],[data-gcs-edit-player],[data-gcs-save-player],[data-gcs-cancel-player],[data-gcs-delete-player],[data-gcs-delta],[data-gcs-reset]')||String(b.dataset.gmcAction||'').startsWith('seal-'))return null;
