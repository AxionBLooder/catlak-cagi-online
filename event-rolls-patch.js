...
window.addEventListener('pointerdown',e=>{
 ...
 if(b&&erIsGM()&&!b.classList.contains('on'))document.documentElement.classList.add('cc-roll-entry-pending');
},true);
