(function(){
'use strict';
if(window.__catlakGmCleanClickGuardV5)return;
window.__catlakGmCleanClickGuardV5=true;
...
function dispatch(el){
  ...
  if(el.matches('[data-cc-management-room]')){try{window.__catlakPartyEeliotHotfix?.close?.()}catch(_){}try{api?.close?.()}catch(_){}window.__catlakGmUiPolish?.openManagement?.();return}
