(()=>{
  ...
  if(window.__catlakSiteLiveBootstrapV3||window.__catlakPlayerSheetBootstrapV1)return;
  window.__catlakSiteLiveBootstrapV3=true;
  ...
  load('./battle-room-live-runtime.js','battle-room-live-runtime');
})();
